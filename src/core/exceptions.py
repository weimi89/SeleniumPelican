...
class CaptchaError(LoginError):
    ...
    def __init__(self, message: str, captcha_method: Optional[str] = None, **kwargs):
...
class NavigationError(ScrapingError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        details = {"current_url": current_url, "target_element": target_element, **kwargs}
        super().__init__(message, details)
...
class IframeError(NavigationError):
    ...
    def __init__(self, message: str, iframe_name: Optional[str] = None, **kwargs):
...
class RecordFilterError(DataError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        details = {"filter_criteria": filter_criteria, "matched_count": matched_count, **kwargs}
        super().__init__(message, **details)
...
class ConfigurationError(ValidationError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        details = {"config_file": config_file, "config_section": config_section, **kwargs}
        super().__init__(message, **details)
...
class TimeoutError(ScrapingError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        details = {"timeout_duration": timeout_duration, "operation": operation, **kwargs}
        super().__init__(message, details)
...
class WebDriverError(ScrapingError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        details = {"driver_version": driver_version, "browser_version": browser_version, **kwargs}
        super().__init__(message, details)
...
def create_exception(exception_type: str, message: str, **kwargs) -> ScrapingError:
    """
...
class ExceptionAnalyzer:
    ...
    def analyze_selenium_exception(exception: Exception) -> Dict[str, Any]:
        """分析 Selenium 相關異常"""
        analysis = {"type": "selenium", "details": {}}

        exception_str = str(exception).lower()

        # 常見的 Selenium 異常模式分析
        if "no such element" in exception_str:
            analysis["details"]["issue"] = "element_not_found"
            analysis["details"]["suggestion"] = "檢查元素選擇器或等待元素出現"
        elif "timeout" in exception_str:
            analysis["details"]["issue"] = "timeout"
            analysis["details"]["suggestion"] = "增加等待時間或檢查網路連線"
        elif "stale element" in exception_str:
            analysis["details"]["issue"] = "stale_element"
            analysis["details"]["suggestion"] = "重新尋找元素"
        elif "no such frame" in exception_str:
            analysis["details"]["issue"] = "frame_not_found"
            analysis["details"]["suggestion"] = "檢查 iframe 名稱或 ID"
        elif "alert" in exception_str:
            analysis["details"]["issue"] = "unexpected_alert"
            analysis["details"]["suggestion"] = "處理彈出視窗"
...
class AdvancedScrapingError(ScrapingError):
    ...
    def _determine_severity(self) -> str:
        ...
        if any(critical in message_lower for critical in ["critical", "fatal", "crashed"]):
            return "critical"
